   ...
   */
		...
		"aF": function aF() {
          ...
          continue;
						...
						obsObj = { type: "array", insertedItems: args, index: index };
						if (watch && watch.length) {
							watch.forEach(function (wObj) {
								store.$.arrayChange(wObj.rec, wObj.attr, array, wObj.oldValue, obsObj);
...
//$Id$
Lyte.registerErrorCodes(_defineProperty({
